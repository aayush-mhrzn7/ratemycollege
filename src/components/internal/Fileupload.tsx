...
export default function CustomDropzone() {
  ...
  return (
    <div {...getRootProps()}>
      ...
      {isDragActive ? (
        <div className="h-[300px] relative w-[600px] rounded-2xl border-border flex flex-col gap-6 justify-center items-center  border-2 border-dashed">
        ...
        <>
          <div className="h-[300px] cursor-pointer w-[600px] rounded-2xl border-border flex flex-col gap-6 justify-center items-center  border-2 border-dashed">
            ...
            {files.map((file) => (
              <div className="relative">
                <Image
                  ...
                  height={200}
                  width={200}
                  className="object-cover w-full h-[300px] border-2 border-border rounded-xl"
                />
                <Button
                  variant={"destructive"}
